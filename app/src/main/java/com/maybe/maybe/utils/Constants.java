...
public class Constants {
    ...
    public static final String ACTION_CHANGE_MUSIC = PACKAGE_NAME + ".ACTION_CHANGE_MUSIC";
    public static final String ACTION_CHANGE_LIST = PACKAGE_NAME + ".ACTION_CHANGE_LIST";
